    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      {productLoading || ordersLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="shadow-md rounded-md p-4 transition-transform duration-300 hover:scale-105">
            ...
            <tbody>
              {orders.length > 0 ? (
                orders.map((order) => (
                  <tr
                    key={order._id}
                    className="border-b border-b-gray-100 hover:bg-gray-200 cursor-pointer"
                  >
